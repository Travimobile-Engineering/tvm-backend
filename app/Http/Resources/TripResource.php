...
class TripResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $selectedSeats = $this->tripBookings ? explode(',', str_replace(['[',']','"'], '', implode(',',$this->tripBookings->map(function ($passenger) {
            return $passenger->selected_seat;
        })->toArray()))) : [];
        $totalSelectedSeats = $this->tripBookings ? $this->tripBookings->count() : 0;
        $availableSeats = collect($seats)->filter(fn($item) => !in_array($item, $selectedSeats))->toArray();
        ...
        return [
            ...
            'vehicle' => (object)[
                ...
                'seats' => $this->vehicle?->seats ?? $this->vehicle?->seats,
            ...
            'available_seat_count' => $availableSeatCount,
            'manifest_fee' => 20000,
        ];
    }
}
