...
class TripResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'departure_park' => $this->departureRegion?->parks->firstWhere('transit_company_id', '!=', null)?->name,
            'destination' => $this->destinationRegion?->state?->name . ' > ' . $this->destinationRegion?->name,
            'destination_park' => $this->destinationRegion?->parks->firstWhere('transit_company_id', '!=', null)?->name,
