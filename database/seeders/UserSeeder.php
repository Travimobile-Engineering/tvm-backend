...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('users')->insert([
            ['uuid' => '6983571734087474', 'first_name' => 'Admin', 'last_name' => 'Administrator', 'phone_number' => '012345678910', 'email' => 'admin@travimobile.com', 'password' => '$2y$12$RI393MpvWLf6Kq5JXQyTYOoLbkf7BT90n/aau1fO/mcE6G/waPLAC', 'user_category'=>UserType::PASSENGER.','.UserType::SUPERADMIN.','.UserType::COPORATEDRIVER, 'verification_code' => '09458', 'email_verified' => 1, 'email_verified_at' => date('Y-m-d H:i:s')],
